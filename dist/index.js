...
var BASE = 'https://api.todoist.com/sync/v9';
var COLORS_BY_ID = {
    'berry_red': '#b8256f',
    'red': '#db4035',
    'orange': '#ff9933',
 ...
 */
var Todoist$1 = function (token, userOptions) {
    ...
    var client = got__default["default"].extend({ method: 'POST', responseType: 'json' });
    ...
    var labels = {
        ...
        deleteOccurrences: createCommand('label', 'deleteOccurrences'),
        rename: createCommand('label', 'rename'),
...
Todoist$1.colorsById = COLORS_BY_ID;
Todoist$1.getColor = function (id) { return COLORS_BY_ID[id]; };
